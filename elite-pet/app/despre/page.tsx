...
export default function DespreNoi() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] font-sans flex flex-col">
      ...
      {/* CONȚINUT PAGINĂ */}
      <div className="flex-grow max-w-4xl mx-auto p-6 mt-4 mb-12">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="h-64 bg-green-600 relative overflow-hidden flex items-center justify-center">
            <h1 className="text-4xl md:text-5xl font-black text-white z-10 relative">Povestea ElitePet</h1>
            <div className="absolute inset-0 opacity-20 text-[200px] text-center -mt-10">🐶🐱</div>
          </div>
          
          <div className="p-8 md:p-12 text-black text-lg leading-relaxed font-medium">
            <h2 className="text-2xl font-black mb-4">Din dragoste pentru necuvântătoare</h2>
            <p className="mb-6">ElitePet a luat naștere din dorința de a oferi părinților de animale un loc unic, de încredere, de unde pot achiziționa tot ce este mai bun pentru blănoșii lor. Știm că animalul tău nu este doar un "animal", ci un membru al familiei.</p>
            <p className="mb-6">Am început ca un mic magazin de cartier în 2020, iar astăzi, datorită încrederii voastre, am ajuns unul dintre cele mai apreciate petshop-uri online din România.</p>
            <h2 className="text-2xl font-black mt-10 mb-4 text-green-600">Misiunea Noastră</h2>
            <ul className="list-disc pl-6 space-y-2 mb-6 font-bold">
              <li>Să selectăm doar produse premium, sigure pentru animale.</li>
              <li>Să oferim suport și consiliere de specialitate.</li>
              <li>Să asigurăm livrare rapidă, pentru că foamea (sau cheful de joacă) nu așteaptă!</li>
            </ul>
            <div className="mt-10 bg-orange-50 p-6 rounded-xl border border-orange-200 text-center">
              <h3 className="font-black text-xl mb-2">Vrei să ne cunoști mai bine?</h3>
              <p className="text-sm font-bold text-gray-700 mb-4">Te așteptăm în vizită în magazinul nostru fizic sau online!</p>
              <Link href="/produse" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-lg transition">Descoperă Produsele</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-[#183251] text-white pt-12 pb-6 border-t-4 border-green-500 mt-auto">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 border-b border-blue-900 pb-8">
          <div>
            ...
            <p className="text-blue-200 text-sm mt-4 font-medium leading-relaxed">Pasiunea noastră este fericirea animalului tău de companie. Oferim cele mai bune produse, la cele mai bune prețuri, cu livrare rapidă.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-3 flex flex-col">
              <a href="https://anpc.ro/" target="_blank" rel="noreferrer" className="block border border-gray-400 bg-white p-2 rounded flex items-center justify-center hover:bg-gray-100 transition"><span className="text-black font-black text-xs">ANPC - SAL</span></a>
              <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noreferrer" className="block border border-gray-400 bg-white p-2 rounded flex items-center justify-center hover:bg-gray-100 transition"><span className="text-black font-black text-xs">SOL - Litigii Online</span></a>
              <a href="https://www.anaf.ro/" target="_blank" rel="noreferrer" className="block border border-gray-400 bg-white p-2 rounded flex items-center justify-center hover:bg-gray-100 transition mt-2"><span className="text-blue-900 font-black text-xs">A.N.A.F.</span></a>
            </div>
          </div>
        </div>
